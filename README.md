...
This project is divided into three core components, fulfilling the requirements up to Task 3 of the practical:
...
* **The Server** receives the characters and responds with `"JumpsOver The LazyFox"`.
